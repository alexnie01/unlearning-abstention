...
OUT = os.path.join(ROOT, "results", "02_epistemic_direction")
ACTS = os.path.join(ROOT, "results", "activations")
LABELS = os.path.join(ROOT, "results", "01_idk_behavior")
N = 100
